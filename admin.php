...
<head>
    <meta charset="utf-8">
    <title>Cabin - Administrador</title>
    ...
    <script src="./config/AdminOptions.js"></script>
</head>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3"><strong>Administradores</strong></h1>
                    <p>Gestion de la pagina web</p>
                </div>
                <div class="row g-4">
                    <div class="col-12">
                        <div id="Admin-page" class="row gy-4">
                        </div>
                    </div>
                </div>
            </div>
