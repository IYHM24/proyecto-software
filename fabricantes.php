        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3"><strong>Gestion de fabricantes</strong></h1>
                    <p>Nuestros fabricantes</p>
                </div>

                <button class="btn btn-primary mb-5" onclick="modalFabricante();">+</button>
                <?php
                include "./conectors/conexion.php";
                try {
                    if (isset($_GET["nombre"]) && isset($_GET["nit"])) {
                        $nombre = $_GET["nombre"];
                        $nit = $_GET["nit"];
                        if ($nombre != "" && $nit != "") {
                            $sql = "
                                INSERT INTO fabricante (nombre,nit)
                                VALUES ('" . $nombre . "','" . $nit . "'); 
                            ";
                            $myPDO->query($sql);
                            echo "
                    ...
                    <tbody>
                        ...
                        foreach ($myPDO->query($sql) as $row) {
                            ...
                            <tr>
                                ...
                                <td>' . $row["nombre"] . '</td>
                                <td>' . $row["nit"] . '</td>
                                <td><a class="btn" href="./conectors/eliminar.php?id_fabricante=' . $row["id_fabricante"] . '"><i class="fa fa-solid fa-trash text-primary"></i></a></td>
                            </tr>    
                            ';
                            $rowP++;
                        }
